import { Instance, Model, Sequelize, DataTypes, CreateOptions } from "sequelize";
...
export interface UserModel extends BaseModelInterface, Model<UserInstance, UserAttributes> {}
